...
export const Resumen = () => {
  ...
  const resumenGuardado = async () => {
    const msg = {
      id_clase: contexto.idClase,
      language: contexto.lenguaje,
    };
    try {
      await fetch(`http://10.0.2.2:8000/api/v1/resumenesExistente/`, {
        method: 'POST',
        mode: 'cors',
        headers: {
          'Content-Type': 'application/json',
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={generatePDF} style={styles.btnDescargar}>
        <Text style={{fontSize: 20, color: '#303030', fontWeight: '700'}}>
          Descargar
        </Text>
      </Pressable>
